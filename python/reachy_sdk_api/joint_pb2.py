...
_JOINTSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='reachy.sdk.joint.JointState.timestamp', index=11,
...
_JOINTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='reachy.sdk.joint.JointService.StreamAllJointsState',
    index=2,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='SendCommands',
    full_name='reachy.sdk.joint.JointService.SendCommands',
    index=3,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='reachy.sdk.joint.JointService.StreamJointsCommand',
    index=4,
    containing_service=None,
    input_type=_JOINTSCOMMAND,
    output_type=_JOINTCOMMANDACK,
